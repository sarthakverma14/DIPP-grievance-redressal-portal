...
<v-dialog v-model="installapp" max-width="800px">
      ...
      <v-container>
          ...
          <v-flex xs12>
            <v-container>
              ...
              <v-layout row wrap>
                ...
                <v-flex xs12 sm6 self-align-center>
                  <p>
                    ...
                    <span class="font-weight-light subheading info--text">{{convertTime(currcase.date)}}</span>
                  </p>
                </v-flex>
                <v-flex xs12>
                  <br>
              ...
              <!-- <v-layout row wrap>
                                            <v-flex xs12>
                                                <h2 class="font-weight-regular headline">
                                                    <v-icon class="fas fa-location-arrow accent--text mr-2"></v-icon>Actions
                                                </h2>
                                            </v-flex>
                                            <v-flex xs12>
                                                <br>
        ...
        <v-footer fixed inset app height="auto" class="mb-0">
          <!-- <v-bottom-nav :active.sync="bottomNav" light :value="true"  shift> -->
            <v-layout row >              
              <v-flex xs12 sm3 class="text-xs-center">
                <v-btn flat color="info" @click="trans">
                  <v-icon class="fas fa-exchange-alt" small left></v-icon><span v-if="!$vuetify.breakpoint.xsOnly">Transfer</span>
                </v-btn>
              </v-flex>
              <v-flex xs12 sm3 class="text-xs-center">
                <v-btn flat color="error" @click="rej">
                  <v-icon class="fas fa-ban" small left></v-icon><span v-if="!$vuetify.breakpoint.xsOnly">Reject</span>
                </v-btn>
              </v-flex>
              <v-flex xs12 sm3 class="text-xs-center">
                <v-btn flat color="deep-purple accent-1" @click="chatinitiate">
                  <v-icon small left class="fas fa-comments"></v-icon><span v-if="!$vuetify.breakpoint.xsOnly">Chat</span>
                </v-btn>
              </v-flex>
              <v-flex xs12 sm3 class="text-xs-center">
                <v-btn flat color="success" @click="app">
                  <v-icon class="fas fa-thumbs-up" small left></v-icon><span v-if="!$vuetify.breakpoint.xsOnly">Approve</span>
                </v-btn>
              </v-flex>
            </v-layout>
          <!-- </v-bottom-nav> -->
